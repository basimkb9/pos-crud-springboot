...
public class TransactionDetailsSpecification implements Specification<TransactionDetails> {

    private SearchCriteria searchCriteria;

    public TransactionDetailsSpecification(SearchCriteria searchCriteria){
        this.searchCriteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<TransactionDetails> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
